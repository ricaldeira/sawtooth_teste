...
_SIMPLESUPPLYPAYLOAD_ACTION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CREATE_CAR', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_CAR', index=7, number=7,
      serialized_options=None,
      type=None),
  ],
...
_SIMPLESUPPLYPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_car', full_name='SimpleSupplyPayload.create_car', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_car', full_name='SimpleSupplyPayload.update_car', index=9,
...
_SIMPLESUPPLYPAYLOAD.fields_by_name['create_car'].message_type = _CREATECARACTION
_SIMPLESUPPLYPAYLOAD.fields_by_name['update_car'].message_type = _UPDATECARACTION
